...
| PostgreSQL 17 | 11 migrations; busca full-text com `tsvector` + índice GIN | [ADR-007](https://github.com/Hibex-Solutions/crystallized-perl/blob/main/docs/adrs/ADR-007-banco-de-dados-relacional-postgresql.md) |
...
| Minion (job queue) | 4 jobs: boas-vindas, SLA, processamento de webhooks, relatórios; instância própria `db-jobs` | [ADR-023](https://github.com/Hibex-Solutions/crystallized-perl/blob/main/docs/adrs/ADR-023-topologia-de-instancias-postgresql.md), [ADR-024](https://github.com/Hibex-Solutions/crystallized-perl/blob/main/docs/adrs/ADR-024-jobs-assincronos-multiplataforma.md) (pendência: Windows nativo) |
